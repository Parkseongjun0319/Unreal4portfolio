...
void ACPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Running", EInputEvent::IE_Released, this, &ACPlayer::DoOffRunning);
	PlayerInputComponent->BindAction("jumping", EInputEvent::IE_Pressed, this, &ACPlayer::Jump);
	PlayerInputComponent->BindAction("jumping", EInputEvent::IE_Released, this, &ACPlayer::Jump);
